...
class MonthsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create month" do
    assert_difference('Month.count') do
      post months_url, params: { month: { description: @month.description, start_date: @month.start_date, title: @month.title } }
    end
  ...
  test "should update month" do
    patch month_url(@month), params: { month: { description: @month.description, start_date: @month.start_date, title: @month.title } }
