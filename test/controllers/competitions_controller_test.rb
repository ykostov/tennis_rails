...
class CompetitionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create competition" do
    assert_difference('Competition.count') do
      post competitions_url, params: { competition: { admin_id: @competition.admin_id, date: @competition.date, info: @competition.info, time: @competition.time, title: @competition.title } }
    end
  ...
  test "should update competition" do
    patch competition_url(@competition), params: { competition: { admin_id: @competition.admin_id, date: @competition.date, info: @competition.info, time: @competition.time, title: @competition.title } }
